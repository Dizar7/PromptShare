...
**PromptShare**는 개인의 로컬 환경이나 개별 저장소에 파편화되어 있는 AI 활용 노하우(Skill)를 전사적으로 통합하고 자산화하기 위한 **풀스택 글로벌 플랫폼**입니다. 비개발 직군도 손쉽게 자신의 업무 노하우를 표준화된 'AI 스킬 파일'로 변환하고, GitHub를 통해 전사적으로 공유할 수 있도록 돕습니다.

- **프로젝트 기간**: 2026.04 (고도화 완료)
- **팀 규모**: 1인 (Solo Project)
- **담당**: 기획(PRD 작성), UI/UX 디자인, 풀스택 개발(Front/Back), DB 설계, AI API 연동

> 본 프로젝트는 **AI 코딩 어시스턴트(Antigravity)**와 협업하여 기획부터 배포 준비까지 최단 기간에 완수하며 생산성을 극대화한 사례입니다.
